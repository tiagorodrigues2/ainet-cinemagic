            ...
            <div class="flex-col items-center mb-4">
                ...
                <form action="{{ route('employees.save') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" name="name" type="text" placeholder="Enter name" value={{ $employee->name }}>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" style="cursor: pointer" id="type" name="type">
                            @if ($employee->type == 'E')
