            ...
            <div class="mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-around h-16">
                    ...
                    <div class="flex items-center">
                            ...
                            <div class="relative inline-block text-left">
                                ...
                                <div id="user-dropdown-content" class="hidden absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                    <div class="py-1" role="none">
                                        <a href="{{ route('profile') }}" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">Account Settings</a>
                                        ...
                                        @if (auth()->user()->isAdmin())
                                            <a href="{{ route('prices') }}" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-1">Manage Prices <span class="text-red-800 text-sm ml-auto">A</span></a>
                                            ...
                                            <a href="{{ route('theaters') }}" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-1">Manage Theaters <span class="text-red-800 text-sm ml-auto">A</span></a>
                                            <a href="#" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-1">Manage Movies <span class="text-red-800 text-sm ml-auto">A</span></a>
                                            <a href="#" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-1">Manage Screenings <span class="text-red-800 text-sm ml-auto">A</span></a>
                                            @endif
                                        @if (auth()->user()->isManager() || auth()->user()->isAdmin())
                                            <a href="{{ route('tickets.scan') }}" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-1">Scan Tickets <span class="text-yellow-800 text-sm ml-auto">E</span></a>
                                        @endif
                        ...
                        <a href="{{ route('cart.checkout') }}" class="font-semibold text-white shadow-sm bg-red-900 hover:bg-red-800 px-3 py-2 rounded-md text-sm ms-8">
                            Cart
                            @if (session()->has('cart'))
